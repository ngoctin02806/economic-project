...
const bootstrap = (function(t, e, n) {
  ...
  const s = (function() {
    ...
    function i() {
      ...
      for (const e in o)
        if (typeof t.style[e] !== 'undefined') return { end: o[e] };
      return !1;
    }
    function s(t) {
      const n = this;
    ...
    var a = {
      ...
      typeCheckConfig(e, n, i) {
        for (const s in i)
          if (Object.prototype.hasOwnProperty.call(i, s)) {
            const r = i[s];
            const o = n[s];
            const l = o && a.isElement(o) ? 'element' : t(o);
  ...
  const a = (function() {
    ...
    const o = { ALERT: 'alert', FADE: 'fade', SHOW: 'show' };
    const a = (function() {
      function t(t) {
        this._element = t;
      }
      ...
      return (
        ...
        (n._getRootElement = function(t) {
          const n = s.getSelectorFromElement(t);
          let i = !1;
          return (
  ...
  const l = (function() {
    const t = 'button';
    const n = e.fn[t];
    const i = { ACTIVE: 'active', BUTTON: 'btn', FOCUS: 'focus' };
    const s = {
    ...
    const a = (function() {
      ...
      return (
        (n.toggle = function() {
          let t = !0;
          let n = !0;
          const r = e(this._element).closest(s.DATA_TOGGLE)[0];
          if (r) {
            const o = e(this._element).find(s.INPUT)[0];
            if (o) {
              if (o.type === 'radio')
                if (o.checked && e(this._element).hasClass(i.ACTIVE)) t = !1;
                else {
                  const a = e(r).find(s.ACTIVE)[0];
  ...
  const h = (function() {
    ...
    const h = { NEXT: 'next', PREV: 'prev', LEFT: 'left', RIGHT: 'right' };
    const c = {
      SLIDE: `slide${i}`,
      SLID: `slid${i}`,
      KEYDOWN: `keydown${i}`,
      ...
      return (
        ...
        (f._getItemByDirection = function(t, e) {
          ...
          if (((i && s === 0) || (n && s === r)) && !this._config.wrap)
            return e;
          const o = (s + (t === h.PREV ? -1 : 1)) % this._items.length;
          return o === -1
        ...
        (f._triggerSlideEvent = function(t, n) {
          ...
          const s = this._getItemIndex(e(this._element).find(d.ACTIVE_ITEM)[0]);
          const r = e.Event(c.SLIDE, {
            relatedTarget: t,
            direction: n,
            from: s,
            to: i,
        ...
        (f._slide = function(t, n) {
          ...
          let o;
          const a = this;
          const l = e(this._element).find(d.ACTIVE_ITEM)[0];
          const f = this._getItemIndex(l);
          const _ = n || (l && this._getItemByDirection(t, l));
          const g = this._getItemIndex(_);
          const m = Boolean(this._interval);
          if (
            (t === h.NEXT
        ...
        (o._jQueryInterface = function(t) {
          return this.each(function() {
            let i = e(this).data(n);
            const s = e.extend({}, a, e(this).data());
            typeof t === 'object' && e.extend(s, t);
            const r = typeof t === 'string' ? t : s.slide;
            if (
        ...
        (o._dataApiClickHandler = function(t) {
          const i = s.getSelectorFromElement(this);
          if (i) {
            const r = e(i)[0];
            if (r && e(r).hasClass(u.CAROUSEL)) {
              const a = e.extend({}, e(r).data(), e(this).data());
  ...
  const c = (function() {
    ...
    const n = 'bs.collapse';
    const i = e.fn[t];
    const o = { toggle: !0, parent: '' };
    const a = { toggle: 'boolean', parent: '(string|element)' };
    const l = {
    ...
    const c = { WIDTH: 'width', HEIGHT: 'height' };
    const u = {
    ...
    const d = (function() {
      function i(t, n) {
        ...
        for (let i = e(u.DATA_TOGGLE), r = 0; r < i.length; r++) {
          const o = i[r];
          const a = s.getSelectorFromElement(o);
      ...
      return (
            ...
            if (
              ...
              if ((e(this._element).trigger(a), !a.isDefaultPrevented())) {
                ...
                if (s.supportsTransitionEnd()) {
                  const f = `scroll${c[0].toUpperCase() + c.slice(1)}`;
                  e(this._element)
        ...
        (i._jQueryInterface = function(t) {
          return this.each(function() {
            const s = e(this);
            let r = s.data(n);
            const a = e.extend({}, o, s.data(), typeof t === 'object' && t);
            if (
    ...
    return (
      e(document).on(l.CLICK_DATA_API, u.DATA_TOGGLE, function(t) {
        ...
        const i = e(this);
        const r = s.getSelectorFromElement(this);
        e(r).each(function() {
          const t = e(this);
          const s = t.data(n) ? 'toggle' : i.data();
  ...
  const u = (function() {
    ...
    const f = { offset: 0, flip: !0 };
    const _ = { offset: '(number|string|function)', flip: 'boolean' };
    const g = (function() {
      function a(t, e) {
        (this._element = t),
          (this._popper = null),
      ...
      return (
        (g.toggle = function() {
          if (
            ...
            const t = a._getParentFromElement(this._element);
            const i = e(this._menu).hasClass(c.SHOW);
            if ((a._clearMenus(), !i)) {
              const s = { relatedTarget: this._element };
              const r = e.Event(h.SHOW, s);
        ...
        (g._getPlacement = function() {
          const t = e(this._element).parent();
          let n = d.BOTTOM;
          return (
            t.hasClass(c.DROPUP)
              ? ((n = d.TOP),
        ...
        (a._clearMenus = function(t) {
          if (!t || (t.which !== 3 && (t.type !== 'keyup' || t.which === 9)))
            for (
              let n = e.makeArray(e(u.DATA_TOGGLE)), s = 0;
              s < n.length;
              s++
            ) {
              const r = a._getParentFromElement(n[s]);
              const o = e(n[s]).data(i);
        ...
        (a._getParentFromElement = function(t) {
          let n;
          const i = s.getSelectorFromElement(t);
        ...
        (a._dataApiKeydownHandler = function(t) {
          if (
            ...
            if (
              ...
              if (t.which === 27) {
                const o = e(n).find(u.DATA_TOGGLE)[0];
                e(o).trigger('focus');
              }
  ...
  const d = (function() {
    ...
    const n = '.bs.modal';
    const i = e.fn[t];
    const o = { backdrop: !0, keyboard: !0, focus: !0, show: !0 };
    const a = {
      ...
      return (
        ...
        (u.show = function(t) {
          ...
          if (!this._isTransitioning && !this._isShown) {
            ...
            const i = e.Event(l.SHOW, { relatedTarget: t });
            e(this._element).trigger(i),
              this._isShown ||
                ...
                e(this._element).on(l.CLICK_DISMISS, c.DATA_DISMISS, function(
                  t
                ) {
                  return n.hide(t);
                }),
        ...
        (u._showElement = function(t) {
          ...
          const r = e.Event(l.SHOWN, { relatedTarget: t });
          const o = function() {
        ...
        (u._showBackdrop = function(t) {
          const n = this;
          const i = e(this._element).hasClass(h.FADE) ? h.FADE : '';
          if (this._isShown && this._config.backdrop) {
            const r = s.supportsTransitionEnd() && i;
            if (
        ...
        (u._setScrollbar = function() {
          ...
          if (this._isBodyOverflowing) {
            e(c.FIXED_CONTENT).each(function(n, i) {
              const s = e(i)[0].style.paddingRight;
              ...
              e(c.STICKY_CONTENT).each(function(n, i) {
                const s = e(i)[0].style.marginRight;
            ...
            const i = e('body').css('padding-right');
            e('body')
        ...
        (u._resetScrollbar = function() {
          ...
          const t = e('body').data('padding-right');
          typeof t !== 'undefined' &&
            e('body')
              .css('padding-right', t)
              .removeData('padding-right');
  ...
  const f = (function() {
    ...
    const i = '.bs.tooltip';
    const o = e.fn[t];
    const a = new RegExp('(^|\\s)bs-tooltip\\S+', 'g');
    const l = {
      animation: 'boolean',
      template: 'string',
      ...
      return (
        ...
        (m.show = function() {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            const l = s.getUID(this.constructor.NAME);
            a.setAttribute('id', l),
        ...
        (m.hide = function(t) {
          ...
          const r = e.Event(this.constructor.Event.HIDE);
          const o = function() {
        ...
        (m._enter = function(t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            t &&
              (n._activeTrigger[t.type === 'focusin' ? g.FOCUS : g.HOVER] = !0),
        ...
        (m._leave = function(t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            t &&
              (n._activeTrigger[
                t.type === 'focusout' ? g.FOCUS : g.HOVER
              ] = !1),
  ...
  const _ = (function() {
    ...
    const n = '.bs.popover';
    const i = e.fn[t];
    const s = new RegExp('(^|\\s)bs-popover\\S+', 'g');
    const a = e.extend({}, f.Default, {
      placement: 'right',
      trigger: 'click',
      content: '',
      template:
    ...
    const l = e.extend({}, f.DefaultType, {
      content: '(string|element|function)',
    });
    const h = { FADE: 'fade', SHOW: 'show' };
    const c = { TITLE: '.popover-header', CONTENT: '.popover-body' };
    const u = {
      HIDE: `hide${n}`,
      HIDDEN: `hidden${n}`,
      SHOW: `show${n}`,
  ...
  const g = (function() {
    const t = 'scrollspy';
    const n = e.fn[t];
    const i = { offset: 10, method: 'auto', target: '' };
    const o = {
      offset: 'number',
      method: 'string',
    ...
    const c = { OFFSET: 'offset', POSITION: 'position' };
    const u = (function() {
      function n(t, n) {
        const i = this;
        (this._element = t),
      ...
      return (
        (u.refresh = function() {
          ...
          const r = i === c.POSITION ? this._getScrollTop() : 0;
          (this._offsets = []),
            (this._targets = []),
            ...
            e
              ...
              .map(function(t) {
                let n;
                const o = s.getSelectorFromElement(t);
                if ((o && (n = e(o)[0]), n)) {
    ...
    return (
      e(window).on(a.LOAD_DATA_API, function() {
        for (let t = e.makeArray(e(h.DATA_SPY)), n = t.length; n--; ) {
          const i = e(t[n]);
      ...
      return (
        (a.show = function() {
          ...
          if (
            ...
            let r;
            let a;
            const l = e(this._element).closest(o.NAV_LIST_GROUP)[0];
            const h = s.getSelectorFromElement(this._element);
            if (l) {
              const c = l.nodeName === 'UL' ? o.ACTIVE_UL : o.ACTIVE;
              (a = e.makeArray(e(l).find(c))), (a = a[a.length - 1]);
            }
            const u = e.Event(n.HIDE, { relatedTarget: this._element });
            const d = e.Event(n.SHOW, { relatedTarget: a });
            if (
              (a && e(a).trigger(u),
              ...
              const f = function() {
                const i = e.Event(n.HIDDEN, { relatedTarget: t._element });
                const s = e.Event(n.SHOWN, { relatedTarget: a });
        ...
        (a._transitionComplete = function(t, n, r, a) {
          if (n) {
            ...
            const l = e(n.parentNode).find(o.DROPDOWN_ACTIVE_CHILD)[0];
          ...
          if (
            ...
            const h = e(t).closest(o.DROPDOWN)[0];
            h &&
              e(h)
