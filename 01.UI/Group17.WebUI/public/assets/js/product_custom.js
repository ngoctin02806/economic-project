...
$(document).ready(function() {
  ...
  function initColor() {
    if ($('.product_color').length) {
      const selectedCol = $('#selected_color');
      const colorItems = $('.color_list li .color_mark');
      colorItems.each(function() {
        const colorItem = $(this);
        colorItem.on('click', function() {
          const color = colorItem.css('backgroundColor');
  ...
  function initImage() {
    ...
    images.each(function() {
      ...
      image.on('click', function() {
        const imagePath = new String(image.data('image'));
